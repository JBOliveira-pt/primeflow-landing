...
export default function Hero() {
    return (
        <section
            id="Home"
            className="relative w-full h-screen flex items-center justify-center mt-0 pt-0 text-center overflow-hidden"
        >
            {/* IMAGEM DE FUNDO */}
            <Image
            ...
            {/* CONTEÚDO */}
            <div className="flex flex-col justify-center items-center z-10 max-w-5xl px-6 mx-auto text-white gap-8">
                <h1 className="text-5xl md:text-7xl lg:text-7xl font-black tracking-tight leading-[1.1] text-center">
                ...
                <p className="max-w-2xl  text-lg md:text-xl text-slate-400 ">
                    A <strong>Prime Flow</strong> transforma dados complexos em
