...
import { BarChart3, Zap, ShieldCheck, Globe, ChevronRight, Users, FileText, CircleUserRound } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 pt-10 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Desenvolvemos cada recurso focando em performance e facilidade de
            uso...
          </p>
        </div>
